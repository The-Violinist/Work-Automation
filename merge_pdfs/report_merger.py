...
f_key = {
    ...
    "app_use_hits": [
        ...
        "Application_Usage_Applications__User__by_Hits",
    ],
    "block_sites": [
    ...
    "GAV": [
        "Virus_(GAV)_Activity_Trend",
        "Virus_Activity_Trend",
        "ALL_Virus_Activity_Trend",
    ],
    "AD": [
        "AD_Active_Users",
        "AD_Active_Computers",
    ...
    "connected_devices": [
        "connectedDevicesData_Abra",
        "connectedDevicesData_CDA.pdf",
        "connectedDevicesData_PF.pdf",
        "connectedDevicesData_Hayden.pdf",
    ...
    "Sentinel": [
        "SentinelOne",
        "0007 Sentinel One Weekly Threats",
        "0007 Sentinel One Weekly.p",
    ],
}
...
bankcda = [
    ...
    f_key["Sentinel"][1],
    f_key["Sentinel"][2],
    f_key["connected_devices"][1],
    f_key["connected_devices"][2],
    f_key["connected_devices"][3],
    f_key["connected_devices"][4],
    f_key["SO Review"][0],
    f_key["SO Review"][1],
]
cdahonda = [

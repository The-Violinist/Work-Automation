...
"IPS": ["Intrusions_(IPS)_Activity_Trend", "Intrusions__IPS__Activity_Trend", "Intrusions__IPS__Source", "Intrusions__IPS__Signatures", "Intrusions__IPS__Protocol", "Intrusions__IPS__Threat_Level", "Intrusions Prevention Details", "IPS Details.pdf"],
...
"TDR": ["WatchGuardTDR", "TDR_Executive Summary"],
...
honi = [f_key["cover_sheet"], f_key["backup"], f_key["365"][0], f_key["365"][1], f_key["take_control"][0], f_key["take_control"][1], f_key["critical"], f_key["server"], f_key["patch"], f_key["MAV"], f_key["web_protect"][0], f_key["web_protect"][1], f_key["top_cli_host"][1], f_key["top_cli_host"][0], f_key["top_cli_hits"], f_key["pop_domain"][1], f_key["pop_domain"][0], f_key["app_use_bw"][0], f_key["app_use_bw"][1], f_key["active_client"][0], f_key["active_client"][1], f_key["block_sites"][0], f_key["block_sites"][1], f_key["IPS"][0], f_key["IPS"][1], f_key["IPS"][2], f_key["IPS"][3], f_key["IPS"][4], f_key["IPS"][5], f_key["IPS"][6], f_key["IPS"][7], f_key["GAV"][0], f_key["GAV"][1], f_key["botnets"][0], f_key["botnet_detect"][0], f_key["botnet_detect"][1], f_key["botnets"][2], f_key["sslvpn_a_d"][0], f_key["sslvpn_a_d"][1], f_key["TDR"][0], f_key["TDR"][1], f_key["AD"][0], f_key["AD"][1], f_key["AD"][2], f_key["AD"][3]]

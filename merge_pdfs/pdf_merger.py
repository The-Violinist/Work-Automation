...
pffm = [f_key["cover_sheet"], f_key["backup"], f_key["365"][0], f_key["365"][1], f_key["take_control"][0], f_key["critical"], f_key["server"], f_key["patch"], f_key["MAV"], f_key["web_protect"], f_key["top_cli_host"][1], f_key["active_client"][0], f_key["pop_domain"][0], f_key["app_use_bw"][0], f_key["block_sites"][0], f_key["botnets"][0], f_key["botnet_detect"][0], f_key["botnets"][2], f_key["botnet_detect"][1], f_key["IPS"][0], f_key["GAV"][0],  f_key["AD"][0], f_key["AD"][1], f_key["AD"][2], f_key["AD"][3]]
